...
def classify_event(season, event_id, event_name):
    ...
    if season.isdigit():
        ...
        if event_id in ["s25divisionpp", "s25divisionsfrd1la", "s25divisionsfrd1lb", "s25divisionsfrd1lc", "s25divisionsfrd1ld",
                        "s25divisionsfrd1sl1", "s25divisionsfrd1sl2", "s25divisionsfrd1fl"]:
            return "MAIN"
